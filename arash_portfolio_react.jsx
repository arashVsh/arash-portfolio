...
const skills = [
  ...
  },
  {
    title: "Cybersecurity",
    icon: ShieldCheck,
    items: ["Adversarial ML", "Phishing detection", "Network analysis", "Wireshark", "Security+"],
  },
  {
    title: "Cloud & Tools",
    icon: Cloud,
...
const projects = [
  {
    ...
    description:
      "A practical ML security system that detects manipulated images before they can fool vision-language models.",
    ...
    paper: "https://drive.google.com/file/d/1gO2Bix4ztCGMnBHu-YCQkdDGlKMTNpLW/view?usp=drive_link",
    imageDescription:
...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Supported Software Engineering, Data Communication and Network Modeling, and Big Data Analytics courses.",
      ...
      <section id="top" className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 md:grid-cols-[1.05fr_0.95fr] md:py-28">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4 text-sm text-slate-600">
            ...
            <a className="inline-flex items-center gap-2 hover:text-cyan-700" href={profile.linkedin} target="_blank" rel="noreferrer"><Linkedin size={16} /> LinkedIn</a>
            <a className="inline-flex items-center gap-2 hover:text-cyan-700" href={profile.github} target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a>
          </div>
        </motion.div>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white bg-white/80 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur">
            <div className="rounded-[1.5rem] bg-slate-950 p-6 text-white">
              ...
              <div className="mt-5 rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-4 text-sm leading-6 text-cyan-50">
                Picture idea: use a professional headshot or an abstract hero illustration of AI, cybersecurity, and code. Recommended size: square, 1200 × 1200 px.
              </div>
            </div>
          </div>
        </motion.div>
            ...
            <article key={project.title} className="group overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-900/5 transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-900/10">
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {project.github && <LinkButton href={project.github} variant="secondary"><Github size={16} /> GitHub</LinkButton>}
      ...
      <section id="publications" className="bg-slate-50 px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="I have research experience, but I present it as evidence of deep problem-solving, technical writing, and the ability to understand complex systems quickly."
          />
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-xl shadow-slate-900/5">
            ...
            <div className="mt-8 rounded-2xl bg-gradient-to-br from-cyan-50 to-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                MSc Candidate in Computer Science, University of New Brunswick, expected August 2026. Focused on machine learning systems, adversarial robustness, and practical software implementation.
              </p>
              <p className="mt-3 text-sm leading-6 text-slate-600">
        ...
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl shadow-slate-900/20 md:p-12">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="text-3xl font-black md:text-4xl">Looking for someone who can learn fast, build seriously, and communicate clearly?</h2>
              <p className="mt-4 max-w-2xl leading-7 text-slate-300">
                I am looking for machine learning engineering, software development, cybersecurity, and applied AI roles. I can relocate within Canada after graduation and bring a mix of research depth, product mindset, and hands-on implementation.
              </p>
            </div>
            <div className="flex flex-wrap gap-3 md:justify-end">
              <LinkButton href={`mailto:${profile.email}`}>Email Me <Mail size={16} /></LinkButton>
              <LinkButton href={profile.linkedin} variant="secondary">LinkedIn <Linkedin size={16} /></LinkButton>
              <LinkButton href={profile.github} variant="secondary">GitHub <Github size={16} /></LinkButton>
            </div>
          </div>
        </div>
      </section>
